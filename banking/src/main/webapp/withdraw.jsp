  ...
  <section class="home-section">
	...
	<section class="WithDraw-Form">
		<div class="container">
			...
			<input type="hidden" id="with" value="<%= request.getAttribute("with") %>">
				
				<div class="WithDraw-Form">
					<h2 class="form-title">&nbsp;&nbsp;WithDraw-Form </h2>
					<form name="form" action="<%= request.getContextPath()%>/withdr.jsp" method="post" onsubmit="return validate()">
...
var status=document.getElementById("with").value;
if(status=="success"){
	swal("Congrats","Amount WithDrawed","success");
